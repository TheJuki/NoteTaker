...
Interested in contributing to NoteTaker? Want to report a bug? Before
...
[gitter.im][1].
  ...
  [1]: https://gitter.im/TheJuki/NoteTaker
...
[submission guidelines][3].
  ...
  [2]: https://github.com/TheJuki/NoteTaker/issues
...
2. **Build**: Before submitting a pull requests, run a build:electron. This is
  a mandatory requirement for your PR to get accepted, as the app should at
  all times be installable.

3. **Pull Request**: Send a PR to `NoteTaker:master`. If we
